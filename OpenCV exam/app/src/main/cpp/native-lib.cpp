...
// Java_com_devlupin_myapplication_MainActivity_ConvertRGBtoGray
...
Java_com_devlupin_myapplication_MainActivity_loadCascade(JNIEnv *env, jobject thiz, jstring cascade_file_name) {
...
Java_com_devlupin_myapplication_MainActivity_detect(JNIEnv *env, jobject thiz,
...
//                        (char *) "face %d found ", faces.size());
    ...
    ret = faces.size();
        ...
        putText(img_result, "TEST", Point(700, 450), 2, 5, Scalar(0, 0, 0), 15);
