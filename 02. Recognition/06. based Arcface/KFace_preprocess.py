...
def main():
    # make_pair_numpy('data/datasets/haarcascade-kceleb-test', 'data/test_npy/haarcascade-kceleb/', 500)
    # make_pair_numpy('data/datasets/mtcnn-kceleb-test', 'data/test_npy/mtcnn-kceleb/', 500)
    make_pair_numpy('data/datasets/retinaface-kceleb-test', 'data/test_npy/retinaface-kceleb/', 500)
    # make_pair_numpy('data/datasets/roi-kceleb-test', 'data/test_npy/roi-kceleb/', 500)
    # make_pair_numpy('data/datasets/ssd-kceleb-test', 'data/test_npy/ssd-kceleb/', 500)
