package com.devlupin.myapplication;
...
public class MainActivity extends AppCompatActivity
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        try {
            ...
            if(ret != 0) {
//                android.app.AlertDialog show = new android.app.AlertDialog.Builder(MainActivity.this)
//                        .setMessage("얼굴개수")
//                        .setPositiveButton(android.R.string.ok, null)
//                        .show();

                // 액티비티에서 토스트를 쓰던 것처럼 쓰레드에서도 액티비티에 토스트를 띄우려고 할 때 핸들러로 감싸줘야 함.
