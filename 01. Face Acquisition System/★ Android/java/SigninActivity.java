...
public class SigninActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton = (ImageButton) findViewById(R.id.info);
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            String cameraId = manager.getCameraIdList()[1];     // 0번 후면 카메라, 1번 셀카
            ...
            Toast.makeText(SigninActivity.this, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            finish();
