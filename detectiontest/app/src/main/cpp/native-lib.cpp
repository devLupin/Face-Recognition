...
Java_com_devlupin_detectiontest_CaptureActivity_loadCascade(JNIEnv *env, jobject thiz,
...
Java_com_devlupin_detectiontest_CaptureActivity_detect(JNIEnv *env, jobject thiz,
